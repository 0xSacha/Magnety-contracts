...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    token: felt, name: felt, symbol: felt, initial_admin: felt
) {
    _token.write(token);
    _name.write(name);
...
// @return address
@view
func token{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (address: felt) {
...
// @return res result
@view
func supply{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (res: Uint256) {
...
// @return balance
@view
func locked{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(address: felt) -> (
...
// @return res result
@view
func epoch{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (res: felt) {
    let (res) = _epoch.read();
    return (res,);
}
...
// @return point
@view
func point_history{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    epoch: felt
) -> (point: Point) {
...
// @return point
@view
func user_point_history{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
// @return epoch
@view
func user_point_epoch{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    address: felt
) -> (epoch: felt) {
...
// @return change
@view
func slope_changes{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(ts: felt) -> (
    change: felt
) {
...
// @return address of the admin
@view
func future_admin{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    address: felt
) {
...
@view
func get_last_user_slope{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    address: felt
) -> (slope: felt) {
    let (epoch) = _user_point_epoch.read(address);
    let (point: Point) = _user_point_history.read(address, epoch);
...
@view
func user_point_history__ts{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    address: felt, _idx: felt
) -> (ts: felt) {
...
@view
func locked__end{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    address: felt
) -> (end_ts: felt) {
...
@view
func totalSupply{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(t: felt) -> (
    bias: felt
) {
    alloc_locals;
...
@external
func apply_transfer_ownership{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    _only_admin();
...
@external
func checkpoint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
...
@external
func deposit_for{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func create_lock{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func increase_unlock_time{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _unlock_time: felt
) {
    alloc_locals;
...
func _checkpoint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    if (address != 0) {
        ...
        let is_old_locked_end_greater_than_current_timestamp = is_le(
            current_timestamp, old_locked.end_ts
        );
        ...
        let is_new_locked_end_greater_than_current_timestamp = is_le(
            current_timestamp, new_locked.end_ts
        );
...
func _deposit_for{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    if (is_value_equal_to_zero == 0) {
        ERC20.transferFrom(
            contract_address=token, sender=address, recipient=self_address, amount=value
        );
        tempvar syscall_ptr = syscall_ptr;
        tempvar pedersen_ptr = pedersen_ptr;
        tempvar range_check_ptr = range_check_ptr;
...
func _find_block_epoch{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    block: felt, max_epoch: felt
) -> (epoch: felt) {
    let (epoch) = _binary_search_block_epoch(0, 0, max_epoch, block);
    return (epoch,);
}

func _binary_search_block_epoch{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    current_index: felt, _min: felt, _max: felt, block: felt
) -> (epoch: felt) {
    alloc_locals;
    if (current_index == 255) {
        return (_min,);
...
func _binary_search_user_point_block_epoch{
    ...
    return _binary_search_user_point_block_epoch(
        current_index + 1, new_min, new_max, address, block
    );
}
...
func _supply_at{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    point: Point, t: felt
) -> (bias: felt) {
    alloc_locals;
...
func _search_time_bias{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    current_index: felt, t_i: felt, last_point: Point, t: felt
) -> (bias: felt) {
    alloc_locals;
    if (current_index == 255) {
