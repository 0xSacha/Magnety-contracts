...
func only_asset_manager{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    fund: felt
) {
...
@view
func areDependenciesSet{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
    alloc_locals;
...
@view
func getOracle{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (res: felt) {
    let (res: felt) = oracle.read();
    return (res,);
}

@view
func getFeeManager{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getIntegrationManager{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getValueInterpretor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getPrimitivePriceFeed{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getApprovePrelogic{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getSharePriceFeed{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getStackingVaultFee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getDaoTreasuryFee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getMaxFundLevel{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getStackingDispute{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getGuaranteeRatio{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getExitTimestamp{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    res: felt
) {
...
@view
func getCloseFundRequest{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _fund: felt
) -> (res: felt) {
...
@view
func getManagerGuaranteeRatio{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _fund: felt
) -> (res: felt) {
...
@external
func setOrcale{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    oracle_address: felt
) {
...
@external
func setFeeManager{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
...
@external
func setPolicyManager{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
...
@external
func setIntegrationManager{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
...
@external
func addGlobalAllowedAssets{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func addGlobalAllowedExternalPositions{
    ...
    only_dependencies_set();
    let (integration_manager_: felt) = integration_manager.read();
    add_global_allowed_external_positions_from_tab(
        external_positions_len, external_positions, integration_manager_
    );
    return ();
}

@external
func addGlobalAllowedIntegrations{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func addAllowedDepositors{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func initializeFund{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    fund: felt,
    level: felt,
    name: felt,
    symbol: felt,
    ...
    let (is_available_denomination_asset: felt) = IIntegrationManager.isAvailableAsset(
        integration_manager_, denomination_asset
    );
    with_attr error_message("initialize_fund: can not set value to 0") {
    ...
    let (share_price_purchased_: Uint256, _) = SafeUint256.div_rem(
        share_amount_pow18_, shares_amount
    );
    IFuccount.activater(
        fund,
        name,
...
func is_zero{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(x: felt) -> (
    res: felt
) {
    if (x == 0) {
        return (res=1);
...
func add_global_allowed_assets_from_tab{
    ...
    IIntegrationManager.setAvailableIntegration(
        _integration_manager, asset_, APPROVE_SELECTOR, approve_prelogic_, 1
    );
...
func add_global_allowed_external_positions_from_tab{
    ...
    let (VI_: felt) = value_interpretor.read();
    let (isSupportedExternalPosition_) = IValueInterpretor.isSupportedExternalPosition(
        VI_, externalPosition_
    );
...
func add_global_allowed_integration_from_tab{
    ...
    IIntegrationManager.setAvailableIntegration(
        ...
        integration_.contract,
        integration_.selector,
...
func add_allowed_depositors_from_tab{
    ...
    return add_allowed_depositors_from_tab(
        _fund=_fund, _depositors_len=newDepositors_len, _depositors=newDepositors
    );
}
